...
#define LL_GPIO_PIN_ALL                                                                                                \
  (GPIO_BSRR_BS0 | GPIO_BSRR_BS1 | GPIO_BSRR_BS2 | GPIO_BSRR_BS3 | GPIO_BSRR_BS4 | GPIO_BSRR_BS5 | GPIO_BSRR_BS6 |     \
   GPIO_BSRR_BS7 | GPIO_BSRR_BS8 | GPIO_BSRR_BS9 | GPIO_BSRR_BS10 | GPIO_BSRR_BS11 | GPIO_BSRR_BS12 | GPIO_BSRR_BS13 | \
...
{
  return (uint32_t)(READ_BIT(GPIOx->OSPEEDR, (GPIO_OSPEEDR_OSPEED0 << (POSITION_VAL(Pin) * 2U))) >>
                    (POSITION_VAL(Pin) * 2U));
}
 ...
 */
          ...
          (GPIOF) || defined (GPIOG) || defined (GPIOH) || defined (GPIOI) */
/**
 * @}
 */
