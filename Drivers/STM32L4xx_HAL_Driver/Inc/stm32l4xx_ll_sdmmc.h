...
#define SDMMC_CMD_MMC_SLEEP_AWAKE                                                                                      \
  ((uint8_t)5U) /*!< Toggle the device between Sleep state and Standby state.                                 */
...
#define IS_SDMMC_CLOCK_BYPASS(BYPASS)                                                                                  \
  (((BYPASS) == SDMMC_CLOCK_BYPASS_DISABLE) || ((BYPASS) == SDMMC_CLOCK_BYPASS_ENABLE))
/**
 * @}
 */
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx ||     \
...
#define IS_SDMMC_BUS_WIDE(WIDE)                                                                                        \
  (((WIDE) == SDMMC_BUS_WIDE_1B) || ((WIDE) == SDMMC_BUS_WIDE_4B) || ((WIDE) == SDMMC_BUS_WIDE_8B))
/**
 * @}
 */
...
#define IS_SDMMC_SPEED_MODE(MODE)                                                                                      \
  (((MODE) == SDMMC_SPEED_MODE_AUTO) || ((MODE) == SDMMC_SPEED_MODE_DEFAULT) || ((MODE) == SDMMC_SPEED_MODE_HIGH) ||   \
   ((MODE) == SDMMC_SPEED_MODE_ULTRA) || ((MODE) == SDMMC_SPEED_MODE_DDR))
...
#define IS_SDMMC_HARDWARE_FLOW_CONTROL(CONTROL)                                                                        \
  (((CONTROL) == SDMMC_HARDWARE_FLOW_CONTROL_DISABLE) || ((CONTROL) == SDMMC_HARDWARE_FLOW_CONTROL_ENABLE))
/**
 * @}
 */
...
#define IS_SDMMC_TRANSCEIVER(MODE) (((MODE) == SDMMC_TRANSCEIVER_DISABLE) || ((MODE) == SDMMC_TRANSCEIVER_ENABLE))
/**
 * @}
 */
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx ||     \
...
#define IS_SDMMC_RESPONSE(RESPONSE)                                                                                    \
  (((RESPONSE) == SDMMC_RESPONSE_NO) || ((RESPONSE) == SDMMC_RESPONSE_SHORT) || ((RESPONSE) == SDMMC_RESPONSE_LONG))
/**
 * @}
 */
...
#define IS_SDMMC_RESP(RESP)                                                                                            \
  (((RESP) == SDMMC_RESP1) || ((RESP) == SDMMC_RESP2) || ((RESP) == SDMMC_RESP3) || ((RESP) == SDMMC_RESP4))
...
#define IS_SDMMC_TRANSFER_MODE(MODE) (((MODE) == SDMMC_TRANSFER_MODE_BLOCK) || ((MODE) == SDMMC_TRANSFER_MODE_STREAM))
/**
 * @}
 */
...
#define SDMMC_STATIC_FLAGS                                                                                             \
  ((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_DTIMEOUT |                  \
              SDMMC_FLAG_TXUNDERR | SDMMC_FLAG_RXOVERR | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CMDSENT |                     \
              SDMMC_FLAG_DATAEND | SDMMC_FLAG_DHOLD | SDMMC_FLAG_DBCKEND | SDMMC_FLAG_DABORT | SDMMC_FLAG_BUSYD0END |  \
              SDMMC_FLAG_SDIOIT | SDMMC_FLAG_ACKFAIL | SDMMC_FLAG_ACKTIMEOUT | SDMMC_FLAG_VSWEND | SDMMC_FLAG_CKSTOP | \
              SDMMC_FLAG_IDMATE | SDMMC_FLAG_IDMABTC))

#define SDMMC_STATIC_CMD_FLAGS                                                                                         \
  ((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CMDSENT |                    \
              SDMMC_FLAG_BUSYD0END))

#define SDMMC_STATIC_DATA_FLAGS                                                                                        \
  ((uint32_t)(SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_DTIMEOUT | SDMMC_FLAG_TXUNDERR | SDMMC_FLAG_RXOVERR |                   \
              SDMMC_FLAG_DATAEND | SDMMC_FLAG_DHOLD | SDMMC_FLAG_DBCKEND | SDMMC_FLAG_DABORT | SDMMC_FLAG_IDMATE |     \
              SDMMC_FLAG_IDMABTC))
...
#define SDMMC_STATIC_FLAGS                                                                                             \
  ((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_DTIMEOUT |                  \
              SDMMC_FLAG_TXUNDERR | SDMMC_FLAG_RXOVERR | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CMDSENT |                     \
              SDMMC_FLAG_DATAEND | SDMMC_FLAG_DBCKEND | SDMMC_FLAG_SDIOIT))
...
#define CLKCR_CLEAR_MASK                                                                                               \
  ((uint32_t)(SDMMC_CLKCR_CLKDIV | SDMMC_CLKCR_PWRSAV | SDMMC_CLKCR_WIDBUS | SDMMC_CLKCR_NEGEDGE |                     \
              SDMMC_CLKCR_HWFC_EN | SDMMC_CLKCR_DDR | SDMMC_CLKCR_BUSSPEED | SDMMC_CLKCR_SELCLKRX))
#else
#define CLKCR_CLEAR_MASK                                                                                               \
  ((uint32_t)(SDMMC_CLKCR_CLKDIV | SDMMC_CLKCR_PWRSAV | SDMMC_CLKCR_BYPASS | SDMMC_CLKCR_WIDBUS |                      \
...
#define DCTRL_CLEAR_MASK                                                                                               \
  ((uint32_t)(SDMMC_DCTRL_DTEN | SDMMC_DCTRL_DTDIR | SDMMC_DCTRL_DTMODE | SDMMC_DCTRL_DBLOCKSIZE))
...
#define CMD_CLEAR_MASK                                                                                                 \
  ((uint32_t)(SDMMC_CMD_CMDINDEX | SDMMC_CMD_WAITRESP | SDMMC_CMD_WAITINT | SDMMC_CMD_WAITPEND | SDMMC_CMD_CPSMEN |    \
