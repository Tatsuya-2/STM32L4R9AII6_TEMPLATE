...
#define LL_CRS_FREQ_ERROR_DIR_DOWN                                                                                     \
  ((uint32_t)CRS_ISR_FEDIR) /*!< Downcounting direction, the actual frequency is below the target */
/**
 * @}
 */
 ...
 *              or @ref LL_CRS_SYNC_DIV_16 or @ref LL_CRS_SYNC_DIV_32 or @ref LL_CRS_SYNC_DIV_64 or @ref
 * LL_CRS_SYNC_DIV_128
