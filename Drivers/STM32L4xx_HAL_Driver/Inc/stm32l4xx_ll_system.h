...
#define LL_SYSCFG_REMAP_QUADSPI                                                                                        \
  (SYSCFG_MEMRMP_MEM_MODE_2 | SYSCFG_MEMRMP_MEM_MODE_1) /*!< QUADSPI memory mapped at 0x00000000                 */
/**
 * @}
 */
...
#define LL_DBGMCU_TRACE_SYNCH_SIZE1                                                                                    \
  (DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE_0) /*!< TRACE pin assignment for Synchronous Mode with a TRACEDATA size \
                                                     of 1 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE2                                                                                    \
  (DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE_1) /*!< TRACE pin assignment for Synchronous Mode with a TRACEDATA size \
                                                     of 2 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE4                                                                                    \
  (DBGMCU_CR_TRACE_IOEN | DBGMCU_CR_TRACE_MODE) /*!< TRACE pin assignment for Synchronous Mode with a TRACEDATA size   \
                                                   of 4 */
/**
 * @}
 */
