 ...
 ===============================================================================
    ...
    *** Low Power modes configuration ***
    ...
    [..]
      ...
      (+) Low-power Sleep mode: Cortex-M4 core stopped, peripherals kept running, main regulator off, low power
regulator on.
      ...
      (+) Stop 2 mode: all clocks are stopped except LSI and LSE, main regulator off, low power regulator on, reduced
set of waking up IPs compared to Stop 1 mode.
      (+) Standby mode with SRAM2: all clocks are stopped except LSI and LSE, SRAM2 content preserved, main regulator
   ...
   =========================================
    [..]
      (+) Entry:
          ...
          in specifying whether or not the regulator is forced to low-power mode and if exit is interrupt or
event-triggered.
   ...
   ===============================
    [..]
      (+) Entry:
          ...
          (++) HAL_PWREx_EnterSTOP0Mode() for mode 0 or HAL_PWREx_EnterSTOP1Mode() for mode 1 or for porting reasons
