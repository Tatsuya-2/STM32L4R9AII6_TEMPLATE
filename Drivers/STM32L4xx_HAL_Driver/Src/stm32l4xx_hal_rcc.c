...
HAL_StatusTypeDef HAL_RCC_OscConfig(RCC_OscInitTypeDef* RCC_OscInitStruct)
{
  ...
  if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSI) == RCC_OSCILLATORTYPE_LSI)
  {
    ...
    if (RCC_OscInitStruct->LSIState != RCC_LSI_OFF)
    {
      ...
      {
        if (((csr_temp & RCC_CSR_LSIRDY) == RCC_CSR_LSIRDY) && ((csr_temp & RCC_CSR_LSION) != RCC_CSR_LSION))
        {
...
#else
            __HAL_RCC_PLL_CONFIG(RCC_OscInitStruct->PLL.PLLSource, RCC_OscInitStruct->PLL.PLLM,
                                 RCC_OscInitStruct->PLL.PLLN, RCC_OscInitStruct->PLL.PLLQ, RCC_OscInitStruct->PLL.PLLR);
#endif
