...
#define osThreadDef(name, priority, instances, stacksz)                                                                \
  ...
  const osThreadDef_t os_thread_def_##name = {                                                                         \
    ...
    { NULL, osThreadDetached, (instances == 1) ? (&os_thread_cb_##name) : NULL,                                        \
      (instances == 1) ? sizeof(StaticTask_t) : 0U, ((stacksz) && (instances == 1)) ? (&os_thread_stack##name) : NULL, \
...
#define osMutexDef(name)                                                                                               \
  ...
  const osMutexDef_t os_mutex_def_##name = { NULL, osMutexRecursive | osMutexPrioInherit, (&os_mutex_cb_##name),       \
