...
public:
  ...
  explicit StreamEncoder_from_BlockEncoder(Args&&... args) : block_encoder_(std::forward<Args>(args)...)
  {
...
public:
  ...
  BlockEncoder_from_ByteEncoder(Args&&... args) : byte_encoder_(std::forward<Args>(args)...)
  {
...
public:
  ...
  StreamEncoder_from_ByteEncoder(Args&&... args) : byte_encoder_(std::forward<Args>(args)...)
  {
    EXPECT_TYPE(T, ByteEncoder);
  }
...
public:
  ...
  VarintByteEncoder(const T& state_variable) : state_variable_(state_variable)
  {
  }
...
{
public:
  CRC8BlockEncoder(TEncoder&& inner_encoder) : inner_encoder_(std::forward<TEncoder>(inner_encoder))
  {
  }
